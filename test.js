...
client.on('message', message => {
  ...
  if (message.author.id !== "437129558995632128") return;
...
if (message.content === '_inv') {
      message.author.send('https://discordapp.com/api/oauth2/authorize?clientid=449359611036827663&permissions=8&scope=bot').catch(e => console.log(e.stack));
...
client.login('NTY5NDc1MDE4NDU5ODQwNTEy.XLxPxg.Wo5SWVdAvwwzo0iI9j2vUrXjHkU');